  ...
  function handleTweets(tweets){
    if (customCallbackFunction === null) {
      ...
      element.innerHTML = html;
		...
		$(".media").each(function(){
			var str = $(this).html();
			if(str.includes("amplify_video_thumb") || str.includes("ext_tw_video_thumb"))
				{
					var status_url = $(this).siblings(".timePosted").find("a").attr("href");
					var status_id = status_url.split("status/").pop()
					console.log(status_id);
					$(this).html("<blockquote class='twitter-video' data-lang='en'><p lang='kn' dir='ltr'> </p> <a href='https://twitter.com/BJP4Karnataka/status/"+status_id+"'></a></blockquote><script async src='https://platform.twitter.com/widgets.js' charset='utf-8'></script>")
				}
      ...
      if (dataOnly) {
        ...
        while (n < x) {
          ...
          if (showImages && images[n] !== undefined && extractImageUrl(images[n]) !== undefined) {
			  console.log("img"+extractImageUrl(images[n]));
            op += '<div class="media">' +
