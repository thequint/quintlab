...
function refresh_popup(index)
{
	...
	$(".mapsvg-region").mousemove(function(e){
  	...
  	case "IN-AR": state="Arunachal Pradesh";party=map_data[index].Arunachal_Pradesh;break;
	case "IN-AS": state="Assam";party=map_data[index].Assam;break;
	case "IN-AP": state="Andhra Pradesh";party=map_data[index].Andhra_Pradesh;break;
	case "IN-BR": state="Bihar";party=map_data[index].Bihar;break;
	case "IN-CT": state="Chhattisgarh";party=map_data[index].Chattisgarh;break;
	case "IN-GA": state="Goa";party=map_data[index].Goa;break;
	case "IN-GJ": state="Gujarat";party=map_data[index].Gujarat;break;
	case "IN-HR": state="Haryana";party=map_data[index].Haryana;break;
	case "IN-HP": state="Himachal Pradesh";party=map_data[index].Himachal_Pradesh;break;
	case "IN-JK": state="Jammu & Kashmir";party=map_data[index].Jammu_Kashmir;break;
	case "IN-JH": state="Jharkhand";party=map_data[index].Jharkhand;break;
	case "IN-KA": state="Karnataka";party=map_data[index].Karnataka;break;
	case "IN-MY": state="Mysore";party=map_data[index].Mysore;break;
	case "IN-KL": state="Kerala";party=map_data[index].Kerala;break;
	case "IN-DL": state="Delhi";party=map_data[index].Delhi;break;
	case "IN-MP": state="Madhya Pradesh";party=map_data[index].Madhya_Pradesh;break;
	case "IN-MH": state="Maharashtra";party=map_data[index].Maharashtra;break;
	case "IN-MN": state="Manipur";party=map_data[index].Manipur;break;
	case "IN-MG": state="Meghalya";party=map_data[index].Meghalya;break;
	case "IN-MZ": state="Mizoram";party=map_data[index].Mizoram;break;
	case "IN-NG": state="Nagaland";party=map_data[index].Nagaland;break;
	case "IN-OR": state="Orissa";party=map_data[index].Orissa;break;
	case "IN-PB": state="Punjab";party=map_data[index].Punjab;break;
	case "IN-PD": state="Pondicherry";party=map_data[index].Pondhicherry;break;
	case "IN-RJ": state="Rajasthan";party=map_data[index].Rajasthan;break;
	case "IN-SK": state="Sikkim";party=map_data[index].Sikkim;break;
	case "IN-TN": state="Tamil Nadu";party=map_data[index].Tamil_Nadi;break;
	case "IN-TG": state="Telangana";party=map_data[index].Telangana;break;
	case "IN-TR": state="Tripura";party=map_data[index].Tripura;break;
	case "IN-UT": state="Uttarakhand";party=map_data[index].Uttarakhand;break;
	case "IN-UP": state="Uttar Pradesh";party=map_data[index].Arunachal_Pradesh;break;
	case "IN-WB": state="West Bengal";party=map_data[index].West_Bengal;break;
	case "IN-BO": state="Bombay";party=map_data[index].Bombay;break;
	case "IN-AJ": state="Ajmer";party=map_data[index].Ajmer;break;
	case "IN-HY": state="Hyderabad";party=map_data[index].Hyderabad;break;
	case "IN-MR": state="Madras";party=map_data[index].Madras;break;
	case "IN-CO": state="Cochin";party=map_data[index].Cochin;break;
	case "IN-CR": state="Coorg";party=map_data[index].Coorg;break;
	case "IN-MD": state="Madhya Bharat";party=map_data[index].Madhya_Bharat;break;
	case "IN-VN": state="Vindhya Pradesh";party=map_data[index].Vindhya_Pradesh;break;
	case "IN-BP": state="Bhopal";party=map_data[index].Bhopal;break;
	...
	$(".pie-1 .graph__percent").mousemove(function(e){
		...
		switch($(this).attr("stroke"))
			{
				case "#3b99cd":party="Congress";vote_percent=map_data[index].Congress_Vote_Percentage;break;
				case "#e27c20":party="BJP";vote_percent=map_data[index].BJP_Vote_Percentage;break;
				case "#a18c8c":party="Others";vote_percent=map_data[index].Others_Vote_Percentage;break;
				case "#d23737":party="Janta Party";vote_percent=map_data[index].Janata_Vote_Percentage;break;	
				default:break;
			}
	...
	$(".pie-2 .graph__percent").mousemove(function(e){
		...
		switch($(this).attr("stroke"))
			{
				case "#3b99cd":party="Congress";seat_share=map_data[index].Congress_LS_seats;break;
				case "#e27c20":party="BJP";seat_share=map_data[index].BJP_LS_seats;break;
				case "#a18c8c":party="Others";seat_share=map_data[index].Others_LS_seats;break;
				case "#d23737":party="Janta Party";seat_share=map_data[index].Janata_Party_LS_Seats;break;	
				default:break;
			}
...
$(".menu ul li").click(function(){
	...
	setTimeout( function() { $(".menu").removeClass("menu--open");	}, 250 );
	nav_open =!nav_open;
})
}
...
function update_data(index)
{
	...
	switch(map_data[index].Year) {
  	case "1952": $(".map-1952").addClass("map-visible");break;
	case "1957": $(".map-1957").addClass("map-visible");break;
	case "1962": $(".map-1957").addClass("map-visible");break;		
	case "1967": $(".map-1967").addClass("map-visible");break;
	case "1971": $(".map-1967").addClass("map-visible");break;		
	case "1977": $(".map-1977").addClass("map-visible");break;
	case "1980": $(".map-1977").addClass("map-visible");break;		
	case "1984": $(".map-1977").addClass("map-visible");break;
	case "1989": $(".map-1977").addClass("map-visible");break;
	case "1991": $(".map-1977").addClass("map-visible");break;		
	case "1996": $(".map-1977").addClass("map-visible");break;
	case "1999": $(".map-1977").addClass("map-visible");break;
	case "2004": $(".map-1999").addClass("map-visible");break;
	case "2009": $(".map-1999").addClass("map-visible");break;	
	case "2014": $(".map-2014").addClass("map-visible");break;		
	default:break;
	}
	...
	$(".timeline-progress").css({"width":step_width +"%" })
	
	$(".ui-slider-range-min").css({"width":step_width +"%" })
	
	
	$(".ui-slider-handle").css({"left":step_width +"%" })
...
function step() {
	...
	$(".ui-slider-horizontal .ui-slider-range-min").css({"width":step_width+"%"});
	$(".ui-slider-handle").css({"left":step_width+"%" })
