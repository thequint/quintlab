// New form quiz sheet
var public_spreadsheet_contact = 'https://docs.google.com/spreadsheets/d/1lOEkDeJ6wZepWKY1jvMhPY_MoxJVqCJcZ7KUAUwfDFw/pubhtml'; // New form quiz sheet
...
function display_data() {
	...
	for (var index = 0; index < data_array.length - 1; index++) {
		...
		// console.log(media);
		$('.questions').append('<div class="question-box"><div class="bullet"><span>' + (index + 1) + '</span></div><div class="question-media">' + media + '</div><div class="question-media--caption">' + data_array[index].mC + '</div><div class="question-headline"><h1 class="headline-text">' + data_array[index].qT + '</h1></div><div class="question-options"><ul class="answer-type demo-list">' + str + '<input type="hidden" id="ques0' + index + '" value="0"></ul><div class="answered-text" style="display:none"><div class="answered-description">' + data_array[index].aT + '</div><div class="answered-media">' + ans_media + '</div><div class="answered-caption">' + data_array[index].aC + '</div></div></div></div>');
		str = '';
	}
