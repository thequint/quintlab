...
function Player(selector, contentInfo) {
  ...
  //window.addEventListener('mousemove', this.onMessage_.bind(this), false)
	
	//setInterval(function(){  this.onMessage_.bind(this)}, 3000);
 ...
 */
//setInterval(function(){ console.log(Player.prototype.onMessage_.message) }, 3000);
